...
<div class="applications view large-10 medium-9 columns">
    ...
    <div class="row">
        <div class="large-5 columns strings">
            ...
            <p><?= h($application->email) ?></p>
            <h6 class="subheader"><?= __('Vacancy') ?></h6>
            <p><?= $application->has('vacancy') ? $this->Html->link($application->vacancy->title, ['controller' => 'Vacancies', 'action' => 'view', $application->vacancy->id]) : '' ?></p>
        </div>
    ...
    <div class="row texts">
        <div class="columns large-9">
            ...
            <?= $this->Text->autoParagraph(h($application->text)) ?>
        </div>
    </div>
</div>
