...
class VacanciesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'vacancies_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'category_id' => 1,
            'created' => '2015-08-12 20:03:17',
            'modified' => '2015-08-12 20:03:17',
            'user_id' => 1
        ],
    ];
}
